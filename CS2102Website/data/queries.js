...
var sql = {
    ...
    add_review: 'UPDATE bid SET review = $1, rating = $2 WHERE pet_owner_username=$3 AND name=$4 AND care_taker_username=$5 AND s_date = $6::date AND s_time = $7::time', //[review, rating, pet_owner_username, pet_name, care_taker_username, s_date, s_time]
